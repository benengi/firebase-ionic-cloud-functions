...
export class TaskCreatePage {
  ...
  ionViewDidLoad() {
    const userProfile: Observable<any> = this.teamProvider.getUserProfile().valueChanges();

    userProfile.subscribe(profile => {
      this.memberList = this.teamProvider.getTeamMemberList(profile.teamId).valueChanges();
    });
  }
